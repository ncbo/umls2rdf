...
# When loading on CUIs, suppress duplicate object-property and rdfs:subClassOf
# triples within a single exported class.
DEDUPE_RELATION_TRIPLES_IN_LOAD_ON_CUIS = True
